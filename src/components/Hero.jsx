      ...
      <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
        <div className="max-w-2xl">
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-gray-800">
            Vegan Desserts with a{" "}
            <span className="text-amber-600">Nostalgic</span> Twist
          </h1>
          <p className="text-lg md:text-xl mb-8 text-gray-700">
            Handcrafted by world-class chefs, delivered to your doorstep.
            Experience the flavors of your childhood, reimagined for today.
          </p>
